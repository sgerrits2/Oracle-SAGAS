...
8. **Configure Tab Layout for Better Workflow**: When using both CloudShell and Code Editor, it's helpful to have them in tabs for easy switching:
   ...
   - This makes it easy to switch between database operations and code editing

    ![Configure Tabs](./images/lab1-task3-11.png "Configure tabs for better workflow")

9. **Your environment is ready to use!** You may now proceed to the next lab.  
